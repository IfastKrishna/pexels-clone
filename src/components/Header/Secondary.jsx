...
const SecondaryHeader = ({ bg = "bg-black/50" }) => {
  ...
  return (
    <header className={`relative  ${isMenuOpen ? "bg-white text-black" : bg}`}>
      <div
        className={`flex justify-between items-center py-3 px-4 sm:px-8 ${
      ...
      >
        ...
        <div className="md:hidden flex items-center gap-4 overflow-auto">
          <button
            className={`py-2 px-4 font-medium rounded-xl ${
              isMenuOpen ? "bg-black text-white" : "bg-white text-black"
            }`}
          >
            Join
          </button>
